...
async def send_markdown_to_api_func(content: str, filename: str, description: str, read_time: int, category: str) -> str:
    ...
    Args:
        ...
        filename: The title/filename for the blog post
